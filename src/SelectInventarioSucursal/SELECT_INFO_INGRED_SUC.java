 ...
 * @author Usuario
 */
public class SELECT_INFO_INGRED_SUC extends javax.swing.JFrame {


    
    private final InvSuc_Controller controller = new InvSuc_Controller();
    
    public SELECT_INFO_INGRED_SUC() {
        initComponents();
        cargarTabla();
    }
    ...
    private void initComponents() {
        ...
        Tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "ID de Producto", "ID de Sucursal", "Stock"
            }
        ));
        ...
        jLabel5.setText("ID de Sucursal");
        ...
        lblIdSucursal.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        lblIdSucursal.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        lblIdSucursal.setText("...");
        lblIdSucursal.setVerticalAlignment(javax.swing.SwingConstants.TOP);
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(lblIdSucursal, javax.swing.GroupLayout.PREFERRED_SIZE, 129, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jLabel6)
                                .addGap(18, 18, 18)
                                .addComponent(lblIdProducto, javax.swing.GroupLayout.PREFERRED_SIZE, 129, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SELECT_INFO_INGRED_SUC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SELECT_INFO_INGRED_SUC().setVisible(true);
            }
        });
    }
