...
public class Ingres_Sucursal extends javax.swing.JInternalFrame {
    
    private final Producto_Controller controller = new Producto_Controller();

    public Ingres_Sucursal() {
        initComponents();
    }
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        try {
            ...
            Logger.getLogger(Ingres_Sucursal.class.getName()).log(Level.SEVERE, null, ex);
        }
